(
bash 01-get-credentials.sh
bash 02-create-root-ca.sh
bash 03-store-certs-to-key-vault.sh
bash 04-create-service-provider-class.sh
bash 05-create-istio-ingress-ns.sh
#bash 06-install-istioctl.sh
bash 07-install-istio.sh
#bash 08-configure-remote-endpoint-secret.sh
