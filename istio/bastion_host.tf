...
#   count = var.bastion_host_enabled && var.location_one != var.location_two ? 1 : 0
...
#   log_analytics_workspace_id = azurerm_log_analytics_workspace.log_analytics_workspace_two[0].id
